...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="dropdown-container">
    ...
    <a href="../Fifth_Year/Dash_announce.php" class="w3-bar-item w3-button w3-padding active">Fifth Year</a>
  </div>
...
<div class="w3-main" style="margin-left:400px;margin-top:43px;">
  ...
  <p class = "heading"><h1><i class = "fa fa-users"></i> Fifth Year Announcements</h1><hr>
  </p><p><strong><i>Here you can upload or delete those notifications which are meant for the fifth year of the department.Kindly upload the file you want to display on the Announcements and Notification section</i></strong></p><br><br>
