...
<?php
    ...
    if (isset($_POST['submit']))
    {
      ...
      if (copy($_FILES['file']['tmp_name'],$file_path))
        {
          $sql = "UPDATE `loginform` SET Assign_5 = '$file_path' WHERE ID = '$id'";
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="dropdown-container1">
    <a href="../../Dash_announc.global" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-globe"></i> Global</a>
    ...
    <a href="../Fifth_Year/Dash_announce.php" class="w3-bar-item w3-button w3-padding w3-blue">Fifth Year</a>
  </div>
  ...
  <div class="dropdown-container1">
    ...
    <a href="../Fifth_Year/Lect.php" class="w3-bar-item w3-button w3-padding w3-blue">Fifth Year</a>
  </div>
  ...
  <div class="dropdown-container">
    ...
    <a href="../Fifth_Year/Assignments.php" class="w3-bar-item w3-button w3-padding active">Fifth Year</a>
  </div>
...
<div class="w3-main" style="margin-left:400px;margin-top:43px;">
  ...
  <p class = "heading"><h1><i class = "fa fa-book"></i>Assignments for Fifth Year Students</h1><hr>
  </p><p><strong><i>Here you can upload or delete those Assignments which are meant for the fifth years of the department.Kindly upload the file you want to display on the Assignments section of the respective year</i></strong></p><br><br>
